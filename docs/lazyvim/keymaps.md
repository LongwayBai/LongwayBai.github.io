...
![Leader 提示界面](/img/lazyvim/leader.png)

*图：按下空格后，底部会弹出快捷键分组提示。对我这种脑容量有限的人来说，这个功能极大地缓解了记不住按键的压力——你只需要记住第一层（比如 g 代表 Git，f 代表文件），剩下的看着提示选就行。*
...
如果只能先记几个，我建议先记下面这 5 个。它们是最容易立刻改变使用体验的：
