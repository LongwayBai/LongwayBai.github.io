...
![安装了 LongwayBai/tmux-config 之后的 tmux 效果图](/img/tmux/cover-effect.png)
...
![tmux 的 session、window、pane、prefix 结构示意图](/img/tmux/structure-diagram.png)
...
![tmux 的最小闭环：new、detach、attach](/img/tmux/minimal-closed-loop.gif)
...
![Catppuccin 主题下的状态栏特写](/img/tmux/status-bar-closeup.png)
