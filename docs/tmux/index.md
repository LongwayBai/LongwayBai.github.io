...
![安装了 LongwayBai/tmux-config 之后的 tmux 效果图](/img/tmux/封面效果图.png)
...
![tmux 的 session、window、pane、prefix 结构示意图](/img/tmux/结构示意图.png)
...
![tmux 的最小闭环：new、detach、attach](/img/tmux/最小闭环图.gif)
...
![Catppuccin 主题下的状态栏特写](/img/tmux/状态栏特写图.png)
